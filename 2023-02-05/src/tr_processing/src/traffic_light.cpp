...
void Camera::find_traffic_light(Mat frame)
{
    ...
    //===============================================================================================================
    threshold(origin_channel_HSV[2], traffic_light_area, 80, 255, /*CV_THRESH_OTSU |*/ THRESH_BINARY_INV);
    threshold(origin_channel_HSV[1], binary_s, 144, 255, /*CV_THRESH_OTSU*/ THRESH_BINARY);
    threshold(origin_channel_BGR[0], binary_b, 48,255, THRESH_BINARY_INV); //88
    //===============================================================================================================
    #endif
    ...
    //bright (morning)
    //===============================================================================================================
    inRange(HSV, Scalar(0, 158, 48), Scalar(40, high_S, high_V), red_area1); //25
    inRange(HSV, Scalar(150, 50, 40), Scalar(180, high_S, high_V), red_area2);
    inRange(HSV, Scalar(45, 158, 48), Scalar(95, high_S, high_V), green_area);
    //===============================================================================================================
    #endif
    ...
    // // dilate(red_area, red_area, mask);
    // erode(red_area, red_area, mask);
    // dilate(red_area, red_area, mask);
    // // erode(red_area, red_area, mask);
    // dilate(red_area, red_area, mask);
